# Generated by Django 4.2.27 on 2026-02-22 17:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('library', '0002_seed_library_permissions'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sales', to='library.customer')),
            ],
            options={
                'db_table': 'sales',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='sale_items', to='library.book')),
                ('sale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='library.sale')),
            ],
            options={
                'db_table': 'sale_items',
